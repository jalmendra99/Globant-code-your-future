...
-- 6. Devuelve un listado que muestre los empleados que no tienen 
...
-- 8. Devuelve las oficinas donde no trabajan ninguno de los empleados que hayan 
...
--    de unidades que se han vendido de cada uno. 
...
--    La base imponible se calcula sumando el coste del producto 
--    por el número de unidades vendidas de la tabla detalle_pedido. 
--    El IVA es el 21 % de la base imponible, 
...
--    Se mostrará el nombre, unidades vendidas, total facturado y total facturado 
...
-- *****************************
-- 
-- 1. Devuelve el nombre, apellido1 y cargo de los empleados 
--    que no representen a ningún cliente.
...
-- 3. Devuelve un listado que muestre solamente los clientes que sí han realizado 
--    ningún pago.
