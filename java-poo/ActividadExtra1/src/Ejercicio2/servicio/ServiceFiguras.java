...
import Ejercicio2.entidad.Rectangulo;
import Ejercicio2.entidad.Hexagono;
import Ejercicio2.entidad.Circulo;
...
public class ServiceFiguras {
    ...
    public static void main(String[] args) {
        ...
        while (mostrarMenu) {
            System.out.println("Cálculo de área y perímetro de figuras geométricas. Opciones:");
