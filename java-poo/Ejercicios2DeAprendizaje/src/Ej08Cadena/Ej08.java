...
import Ej08Cadena.servicio.CadenaService;

public class Ej08 {

    public static void main(String[] args) {

        // Crea un objeto CadenaService para crear e interactuar con Cadenas.
        CadenaService cs = new CadenaService();

        // Crea una Cadena y solicita ingresarla al usuario.
        Cadena ca = cs.crearCadena();

        // Realiza varias pruebas sobre la cadena ingresada
        cs.hacerPruebas(ca);
    }
}
